...
const ourPath = "github.com/PhicLabs/phichain" // Path to our module
...
// conventions in the PhiChain p2p network.
...
//
// If the package that is currently executing is a prefixed by our PhicLabs
