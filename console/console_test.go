...
func newTester(t *testing.T, confOverride func(*ethconfig.Config)) *tester {
	...
	// Create a networkless protocol stack and start an PhiChain service within
	...
	if err != nil {
		t.Fatalf("failed to register PhiChain protocol: %v", err)
	}
