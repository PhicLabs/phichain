...
// Package types contains data types related to PhiChain consensus.
package types
...
// Header represents a block header in the PhiChain blockchain.
type Header struct {
...
// Block represents an entire block in the PhiChain blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the PhiChain
...
// EncodeRLP serializes b into the PhiChain RLP block format.
