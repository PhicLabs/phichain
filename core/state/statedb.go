...
// Package state provides a caching layer atop the PhiChain state trie.
package state
...
import (
	...
	"github.com/PhicLabs/phichain/trie/trienode"
)
...
// StateDB structs within the PhiChain protocol are used to store anything
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/PhicLabs/phichain/pull/16485#issuecomment-380438527),
