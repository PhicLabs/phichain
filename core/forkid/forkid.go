// Package forkid implements EIP-2124 (https://eips.PhiChain.org/EIPS/eip-2124).
package forkid
...
// timestampThreshold is the PhiChain mainnet genesis timestamp. It is used to
...
// NewID calculates the PhiChain fork ID from the chain config, genesis hash, head and time.
...
// NewIDWithChain calculates the PhiChain fork ID from an existing chain instance.
