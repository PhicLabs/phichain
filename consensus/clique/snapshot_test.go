...
// mapped from textual names used in the tests below to actual PhiChain private
...
// address retrieves the PhiChain address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the PhiChain address
	...
	tests := []cliqueTest{
		{
			...
			// batch (https://github.com/PhicLabs/phichain/issues/17593). Whilst this
